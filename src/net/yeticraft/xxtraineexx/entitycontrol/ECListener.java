...
public class ECListener implements Listener {
	...
	Map<Block, ECSpawner> activeSpawners = new HashMap<Block, ECSpawner>();
	Map<UUID, ECMob> activeMobs = new HashMap<UUID, ECMob>();
	...
	public void onCreatureSpawn(CreatureSpawnEvent e) {
		...
		if (!activeSpawners.containsKey(mobSpawner)) {
			...
			activeSpawners.put(mobSpawner, new ECSpawner(player.getName(), mobList, mobSpawner));
			activeMobs.put(spawnedMobUUID, new ECMob(spawnedMob, mobSpawner));
